                    ...
                    <ul>
                      ...
                      {address !== "" ? (
                        <div>
                          <li>
                            {" "}
                            <i class="far fa-address-card"></i> <p>{address}</p>
                          </li>{" "}
                        </div>
                      ) : (
                        <></>
            ...
            <div className="right">
              {profileSummary !== "" ? (
                <>
                  ...
                  <div className="biography">{profileSummary}</div>
                </>
              ) : (
                <></>
              )}
              {pastJob !== "" || presentJob !== "" || futureJob !== "" ? (
                <div className="personality">
                  ...
                  <p className="p">
                    {" "}
                    Past Goals / Present Goals /Future Goals{" "}
                  </p>
                        ...
                        <div className="motivation">
                          ...
                          <div className="motivation2">
                            ...
                            v.graduationEndDate === "" ? (
                              ...
                              <li>
                                {" "}
                                {`${v.graduationStartDate} To Pesent`}
                    ...
                    {skills.map((v, i) =>
                      v.title !== "" ? (
                        <div key={i}>
                          {" "}
                          <p>{v.title}</p>
                          <progress id="file" key={i} value={v.value} max="100">
                            {" "}
                            32%{" "}
                          </progress>
                        </div>
