...
function ResumeSix() {
  ...
  const { firstName, lastName, profession, city, address, phone, email } =
    personalInfo;
    ...
    <div className="resume6">
      <div id="print-content" className="content">
        <img
          ...
          src="/assets/images/Opacity-text.png"
          alt=""
        />
        {firstName !== "" || lastName !== "" || profession !== "" ? (
          <div className="nameandprofession">
            <h3>
              {" "}
              <span className="bolder">{firstName}</span>{" "}
              <span className="lighter">{lastName}</span>{" "}
            </h3>
            <div className="combine">
              {" "}
              <p>{profession}</p> <span className="span"> </span>
            </div>
          </div>
        ) : (
          <></>
                        ...
                        {workExperience.map((v, i) =>
                          ...
                          v.employer === "" ? (
                            ...
                            <div>
                              ...
                              <p className="companyname"> {v.title} </p>
                  ...
                  {skills.map((v, i) =>
                    v.title !== "" ? (
                      <>
                        ...
                        <p class="progress123">
                          {" "}
                          <progress key={i} value={v.value} max="100">
                            {" "}
                            32%{" "}
                          </progress>
                        </p>
                        ...
                        v.instituteLocation === "" ? (
                          ...
                          <div className="workdate">
                            ...
                            v.instituteLocation === "" ? (
                              ...
                              <p>{`${v.graduationStartDate} To Present`}</p>
                            ) : (
                              <p>
                                {`${v.graduationStartDate} To ${v.graduationEndDate}`}
                              </p>
                            )}
                          </div>
                        )
                      ...
                      <div>
                        ...
                        {educationInfo.map((v, i) =>
                          ...
                          v.studyField !== "" ? (
                            <div>
                              <span className="round"> </span>{" "}
                              <p className="companyname"> {v.instituteName} </p>
                              <p className="companyname2">
                                {" "}
                                {v.instituteLocation}{" "}
                              </p>
