  ...
  return (
    <>
      <Row justify="center" style={{ marginTop: "5%" }}>
        <Col span={11}>
          <InputField placeholder="Job TItle" suffix={true} type="text" />
        </Col>

        <Col span={2}></Col>
        <Col span={11}>
          <InputField placeholder="Employer" suffix={true} type="text" />
        </Col>
        ...
        <Col span={2}></Col>
        <Col style={{ marginTop: "7%" }} span={11}>
          <InputField placeholder="State/Province" type="text" />
        </Col>
        ...
        <Col
          id="endDate"
          style={{ marginTop: "7%", marginBottom: "7%", display: "block" }}
          span={11}
        >
        ...
        {checkBox && (
          ...
          >
            <Checkbox id="myCheck" style={{ color: "red" }} onChange={onChange}>
